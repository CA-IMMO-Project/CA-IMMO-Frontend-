...
export default function Hotels() {
  ...
  const totalPages = Math.ceil(mockHotels.length / ITEMS_PER_PAGE);
  const startIndex = (currentPage - 1) * ITEMS_PER_PAGE;
  const currentItems = mockHotels.slice(startIndex, startIndex + ITEMS_PER_PAGE);
    ...
    <div className="bg-brand-50 min-h-screen py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-16 text-center">
          ...
          >
            Réservez votre séjour dans nos établissements partenaires. L'art de recevoir à son apogée.
          </motion.p>
        </div>
