...
export default function Lands() {
  ...
  const totalPages = Math.ceil(mockLands.length / ITEMS_PER_PAGE);
  const startIndex = (currentPage - 1) * ITEMS_PER_PAGE;
  const currentItems = mockLands.slice(startIndex, startIndex + ITEMS_PER_PAGE);
    ...
    <div className="bg-brand-50 min-h-screen py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-16 text-center">
          ...
          >
            Trouvez l'emplacement idéal pour construire votre projet d'exception. Des parcelles uniques dans des cadres privilégiés.
          </motion.p>
        </div>
